...
PUSHPLUS = os.environ.get("PUSHPLUS", "e5f008c2ff234ef082e77e5fde9aebc3")  # PUSHPLUS消息推送Token
...
AGENTID = os.environ.get("AGENTID", "ww4d3b5f952a496bf7,UKeipClgvjsMB2dtts11T8G9DctMOgbmOnFcmPe1IdM,@all,1000002,2EtKHNUhKyOfi_PZyTpBiRMKbH29tpG9x4621SUUG7DSjAJhRB_pP2teMnQS7R8GB")  # agentid企业应用的id
THUMB_MEDIA_ID = os.environ.get("THUMB_MEDIA_ID", "ww4d3b5f952a496bf7,UKeipClgvjsMB2dtts11T8G9DctMOgbmOnFcmPe1IdM,@all,1000002,2EtKHNUhKyOfi_PZyTpBiRMKbH29tpG9x4621SUUG7DSjAJhRB_pP2teMnQS7R8GB") #企业微信素材库图片id
